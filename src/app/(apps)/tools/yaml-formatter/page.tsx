...
export default function YAMLFormatterPage() {
  ...
  const handleFormat = () => {
    ...
    setTimeout(() => {
      // Basic formatting cleanup: strip empty lines, format tabs to double spaces
      const lines = yaml.split('\n')
      const formatted = lines
        .map(line => line.replace(/\t/g, '  ').trimEnd())
        .filter((line, idx, self) => line.trim() !== '' || (idx > 0 && self[idx - 1].trim() !== ''))
        .join('\n')
    ...
    <div className="space-y-8">
      ...
      <Section delay={0.05}>
        <div className="space-y-2">
          ...
          <GradientHeading as="h1" className="text-3xl sm:text-4xl">YAML Formatter</GradientHeading>
          <p className="text-muted-foreground text-xs sm:text-sm">
            Beautify, clean, and fix indentations of unformatted YAML configuration properties client-side.
          </p>
        </div>
      </Section>
            ...
            <Card className="flex flex-col h-[280px]">
              ...
              <CardContent className="flex-1 p-0">
                <textarea
                  ...
                  placeholder="Paste your unformatted YAML logs here..."
          ...
          <div className="lg:col-span-7">
            {result ? (
              ...
              <div className="border border-dashed border-border/60 rounded-xl h-[340px] flex flex-col items-center justify-center text-center text-muted-foreground space-y-2 p-6">
                ...
                <p className="text-sm font-semibold text-foreground/80">Pending YAML Input</p>
                <p className="text-xs max-w-sm">
                  Paste unformatted configurations on the left to structure YAML data columns.
                </p>
              </div>
            )}
          </div>
